...
<body>
    ...
    <div class="content">
        ...
        <!-- Facility -->
        <section id="facil" class="news section">
            <div class="container">
                <div class="row">
            ...
            <div class="section-content">
                <div class="container">
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/log.jpg">
                                <h5>Legal & Qualified Wood Material Sourcing</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/log2.jpg">
                                <h5>Legal & Qualified Wood Material Sourcing</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/log3.png">
                                <h5>Legal & Qualified Wood Material Sourcing</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/saw.jpg">
                                <h5>Sawmill Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/saw2.png">
                                <h5>Sawmill Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/saw3.png">
                                <h5>Sawmill Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/airdry.jpg">
                                <h5>Airdry Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/airdry2.jpg">
                                <h5>Airdry Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/airdry3.jpg">
                                <h5>Airdry Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/kd.jpg">
                                <h5>Kiln Drying Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/kd2.jpg">
                                <h5>Kiln Drying Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/kd3.jpg">
                                <h5>Kiln Drying Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/sortir.jpg">
                                <h5>Grading Sorting Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/sortir2.png">
                                <h5>Grading Sorting Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/sortir3.jpg">
                                <h5>Grading Sorting Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/fj.jpg">
                                <h5>Finger Joint Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/fj2.jpg">
                                <h5>Finger Joint Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/fj3.jpeg">
                                <h5>Finger Joint Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/moulding.png">
                                <h5>Moulding Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/moulding2.jpg">
                                <h5>Moulding Planner Process</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/moulding3.png">
                                <h5>UV Coating Process</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/ship.jpg">
                                <h5>Product Ready to Ship</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/ship2.jpg">
                                <h5>Product Ready to Ship</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/ya/ship3.png">
                                <h5>Product Ready to Ship</h5>
                            </div>
                        </div>
                    </div>
