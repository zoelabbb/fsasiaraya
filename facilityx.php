    ...
    <div class="content">
            ...
            <div class="section-content">
                <div class="container">
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/1.jpg">
                                <h5>Legal & Qualified Wood Material Sourcing</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/2.jpg">
                                <h5>Wood Log Processing With Bandsaw</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/3.jpg">
                                <h5>Accustomed With Efficiency In Management & Organizing</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/4.jpg">
                                <h5>17 Kiln Dry Chambers With High Precision Control Center</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/5.jpg">
                                <h5>High Speed Planner Machines</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/6.jpg">
                                <h5>Rip Machines To Divide Timbers Parallel To The Grain</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/7.jpg">
                                <h5>Cross Cut Process To Match Customer’s Requirements</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/8.jpg">
                                <h5>High Efficiency Moulding Machines</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/9.jpg">
                                <h5>Tooling Workshop To Sharpen Saws & Cutter Heads</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-news">
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/10.jpg">
                                <h5>Neat & Tidy Storage Warehouses</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/11.jpg">
                                <h5>Wood Products Hand Repairing For Final Quality Checking</h5>
                            </div>
                        </div>
                        <div class="col-news col-md-4">
                            <div class="col-news-wrapper">
                                <img alt="" src="img/facility/12.jpg">
                                <h5>Elaborated Load & Dispatch Procedure For Export</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="promo section">
            <div class="container">
                ...
                <a href="#request" data-toggle="modal" class="btn btn-dark wow swing">Order Now</a>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row-base row">
                    ...
                    <div class="col-contacts col-base col-sm-6 col-md-4 col-md-offset-1">
                        ...
                        <a href="mailto:hi.asiaraya@gmail.com" class="email"><span class="__cf_email__"
                                data-cfemail="0960676f6649487b6a61606266276a6664">hi.asiaraya@gmail.com</span></a>
                    </div>
